...
\aboutme{
Ingeniero / desarrollador full-stack  con conocimientos aplicados en el campo de la gestión de operaciones, planificación y control de la producción. Además, he participado activamente en proyectos de transferencia tecnológica.
Soy apasionado en el campo de la tecnologias de la información, especialmente en el desarrollo web y análisis de datos. Mi motivación es ganar experiencia y continuar desarrollando una carrera en la industry IT, a través de la construcción y mantención de aplicaciones que den soluciones a las problemáticas de la industria.
